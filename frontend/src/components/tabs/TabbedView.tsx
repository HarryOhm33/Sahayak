      ...
      <div className="flex-1 flex h-full bg-slate-50 overflow-hidden relative tabbed-layout-wrapper">
        ...
        <div className="w-full bg-white border-b border-slate-200 mobile-tabs-container shrink-0 z-10">
          <div className="flex items-center gap-2 px-4 py-3 overflow-x-auto hide-scrollbar">
            <button
              ...
              className={`shrink-0 px-4 py-2 rounded-xl text-[12px] font-bold transition-all flex items-center gap-2 cursor-pointer ${activeTab === "original_query"
            ...
            {availableTabs.map((tab) => (
              <button
                ...
                className={`shrink-0 px-4 py-2 rounded-xl text-[12px] font-bold transition-all flex items-center gap-2 cursor-pointer ${activeTab === tab
              ...
              >
                ...
                <span
                  className={`text-[9px] py-0.5 px-2 rounded-full font-bold ${activeTab === tab
        ...
        <div className="w-48 sm:w-64 md:w-72 bg-white border-r border-slate-200 flex-col py-6 shrink-0 overflow-y-auto z-10 desktop-sidebar-container">
          ...
          <div className="flex flex-col gap-1 px-2 sm:px-3 mb-6">
            <button
              onClick={() => setActiveTab("original_query")}
              className={`text-left px-3 sm:px-4 py-2.5 rounded-xl text-[13.5px] sm:text-[13px] font-bold transition-all flex items-center justify-between cursor-pointer ${activeTab === "original_query"
                ? "bg-slate-900 text-white"
          ...
          <div className="flex flex-col gap-1 px-2 sm:px-3">
            {availableTabs.map((tab) => (
              <button
                key={tab}
                onClick={() => setActiveTab(tab)}
                className={`text-left px-3 sm:px-4 py-2.5 rounded-xl text-[13.5px] sm:text-[13px] font-bold transition-all flex items-center justify-between cursor-pointer ${activeTab === tab
              ...
              >
                <span>{RELATION_LABELS[tab] || tab}</span>
                <span
                  className={`text-[9px] sm:text-[10px] py-0.5 px-2 rounded-full font-bold shrink-0 ${activeTab === tab
                    ? "bg-blue-100 text-blue-800"
                    : "bg-slate-200 text-slate-600"
                    }`}
                >
